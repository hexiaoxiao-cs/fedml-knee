...
if __name__=="__main__":
    ...
    with Pool(25) as p:
        scores=p.map(process,glob.glob("/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/Sensetime_only_model/*_img.mha"))

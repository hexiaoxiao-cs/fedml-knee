...
def process(img_path):
    ...
    return pic_res
save_dir="./OAI_with_did_Only_sensetime_label"
...
if __name__=="__main__":
    ...
    with Pool(14) as p:
        scores=p.map(process,glob.glob("/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/OAI_with_did_Only_sensetime_label/*_img.mha"))

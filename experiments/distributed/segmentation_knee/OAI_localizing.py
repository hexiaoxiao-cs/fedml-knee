...
Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/OAI_semi_did/semi_OAI/OAI_semi_full_resolution/experiment_10/checkpoint.pth.tar"
def bbox2_3d(img):
...
for i in [4]:
    for (name,file_place) in tqdm.tqdm(unlabel[i]):

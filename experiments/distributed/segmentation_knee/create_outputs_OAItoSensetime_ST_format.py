...
# from experiments.distributed.segmentation_knee.create_outputs_OAItoSensetime_new_dataset import Model_path
...
lbl_sitk_l=[]
# 0.Read image files
path_case = '../../../data/sensetime/list_testing_st_lbl.txt'
base_path= '../../../data/sensetime'
file_path=[]
image_path=[]
label_path=[]
sagittal_num=32
...
idd=[]
net_channel=2
spacing_c_a_s=[0.30303031206131,0.30303031206131,4.5]
scores=pd.DataFrame()
#Sensetime after OAI model with seperation did
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI/OAI_SEMI_Sensetime_bs_2_20_with_did/model_best.pth.tar" #this is with did
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI/Sensetime_Semi_Only_Men/model_best.pth.tar" #This is sensetime only
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI/OAI_SEMI_Sensetime_bs_2_epoch_50/experiment_3/checkpoint.pth.tar" #nonsense
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI_distil/OAI_SEMI_Sensetime_bs_2_20_with_did/model_best.pth.tar" #This is with the KL loss between teacher and student
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI/sensetime_only_w_o_fed/model_best.pth.tar" #This is sensetime training without federated learning and without prior knowledge
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI/OAI_SEMI_Sensetime_bs_2_20_with_did_Senario_One/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI/OAI_SEMI_Sensetime_bs_2_20_with_did_Senario_Two/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI/OAI_SEMI_Sensetime_bs_2_20_with_did_No_Aggregation_No_Pretraining/experiment_0/client0_checkpoint.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI/OAI_SEMI_Sensetime_bs_2_20_with_did_No_Aggregation/experiment_1/client0_checkpoint.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI/ST_full_reso_cropped_comm_30/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI/ST_full_reso_cropped_e_20_c_20/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI/ST_full_reso_cropped_e_30_c_5_reversed_ema/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI/ST_full_reso_cropped_e_30_c_5_reversed_ema_slow_ema_update/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI_distil/ST_full_reso_cropped_kdloss_e_30_c_5_fixed_KL_latest_ema_slow_fix/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI/ST_full_reso_cropped_e30_c10_aggregate_after_comm/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI/ST_full_reso_cropped_e30_c30_both_net_OAI/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI/ST_full_reso_cropped_e30_c30_less_linear_ema/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI_distil/ST_full_reso_cropped_kdloss_e_30_c_5_KL_fixed_no_ema/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI/ST_cropped_both_net_initialized_e30_c30/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI_distil/ST_full_reso_cropped_e_30_c_30_KL_fixed_less_moded_ema_starting_from_10_comm_round/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/OAI_semi_did/semi_OAI/OAI_full_reso_cropped_July/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI_distil/ST_new_lbl_EMA_less_freq_kd_loss/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI/ST_new_lbl_c10a30_normal-ema-5/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI/ST_new_lbl_no_pretraining_c10_e30/model_best.pth.tar"

#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI/ST_st_format_both_net_initialized_e30_c30/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI/ST_st_format_both_pretrained_senario_1/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI/ST_st_format_c10a30_default_ema/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI/ST_st_format_c10a30_ema_after_5_normal_ema/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/OAI_semi_did/semi_OAI/OAI_ST_reso_cropped_July_netchannel4_bs8/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI/ST_st_format_c30e30_ema_after_5_normal_ema/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI_distil/ST_st_format_EMA_less_freq_kd_loss/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/SSFL/ST_SSFL_e30_c30/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/SSFL/ST_SSFL_e30_c30/experiment_10/checkpoint.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/SSFL/ST_SSFL_e30_c30_3/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/SSFL/ST_SSFL_e30_c30_4_lr_001/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI_distil/ST_st_format_EMA_less_freq_kd_loss_on_labeled_scheduled/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/YD/ST_YD_e30_c30_4_lr_005/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/SSFL/ST_SSFL_e30_c30_4_lr_005_No_DICE/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/SSFL/ST_SSFL_e30_c30_4_lr_005/model_best.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI/ST_st_format_no_fed/experiment_0/client1_checkpoint.pth.tar"
#Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI/ST_st_format_both_net_initialized_e30_c30_2/model_best.pth.tar"
Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/sensetime_oai_semi/semi_OAI_distil/ST_st_format_EMA_less_freq_kd_loss_on_labeled_scheduled/experiment_1/checkpoint.pth.tar"
save_path = 'ST_st_format_EMA_less_freq_kd_loss_on_labeled_scheduled_chk/'
with open(path_case, 'r') as f:
    for i in f.readlines():
        path_i = i.split("\n")[0]
        file_path.append(os.path.join(base_path, path_i))
for i in tqdm.tqdm(file_path):
    path_i = i
    image_path.append(path_i)
    path_label = path_i.replace('org', 'seg')
    label_path.append(path_label)
    #id=os.path.basename(path_i).split("_")[0]
    ...
    image.append(resample_img)
    label.append(resampled_label.astype(np.uint8))
    path.append(path_i)
    idd.append(id)
    #print(path_i)
# 1. pre-processing
...
# 2. Vnet prediction
input_ = torch.from_numpy(resample_img[np.newaxis, :][np.newaxis, :])

model = VNet(model_channel=4,
                     out_class=4)
...
for i in tqdm.tqdm(range(len(image))):
    x=torch.from_numpy(image[i][np.newaxis, :][np.newaxis, :])
    pred=model(x.float().cpu())
    ...
    pred_itk.SetSpacing(img_sitk_l[i].GetSpacing())
    ...
    for j in range(3):
        ...
        if not np.any(pred==(j+1)):
            pic_res.append([0,0,0,0,0,0])
            continue

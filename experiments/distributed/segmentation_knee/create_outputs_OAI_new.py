...
Model_path="/research/cbim/vast/xh172/FedCV/experiments/distributed/segmentation_knee/run/OAI_semi_did/semi_OAI/OAI_ST_reso_cropped_Aug_netchannel4_bs8_local_only/experiment_0/client3_checkpoint.pth.tar"
save_path = 'OAI_ST_reso_cropped_Aug_netchannel4_bs8_local_only_3/'
...
for i in file_path:
    ...
    path_i=os.path.join(base_path,"to_st_labeled",subject_name+"_img.mha")
    path_l=os.path.join(base_path,"to_st_labeled",subject_name+"_lbl.mha")
    id = subject_name
    img_sitk = sitk.ReadImage(path_i)
    img_sitk_l.append(img_sitk)
    label_sitk = sitk.ReadImage(path_l)
    ...
    # fixed_size_img = pad_crop(resample_img, (144, 512, 512), mode='constant', value=0)

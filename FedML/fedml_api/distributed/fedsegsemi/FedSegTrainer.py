...
class FedSegTrainer(object):
    ...
    def update_ema_model(self,weights):
        self.trainer.set_ema_params(weights)
    ...
    def train(self):
        ...
        weights_ema=self.trainer.get_ema_params()
        # transform Tensor to list
        if self.args.is_mobile == 1:
            weights = transform_tensor_to_list(weights)
        return weights,weights_ema, self.local_sample_number

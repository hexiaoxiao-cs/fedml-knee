...
def load_OAI_Data(list_file,root_dir,sagittal_slice=32):
    ...
    train_ds = OAI_data(list_file,root_dir=root_dir,sagittal_num=sagittal_slice)
...
def load_sensetime_data_SEMI(list_label,list_bl,list_12m,root_dir,sagittal_slice=32):
    # transform_train, transform_test = _data_transforms_cityscapes(image_size)
    list_label=os.path.join(root_dir,list_label)
    list_bl=os.path.join(root_dir,list_bl)
    list_12m=os.path.join(root_dir,list_12m)
    train_ds = MyData_SEMI(list_label,list_bl,list_12m,root_dir=root_dir,sagittal_num=sagittal_slice)
...
def partition_data(n_nets, sagittal_slice=32):
    ...
    train_ds= load_OAI_Data("train.txt","../../../data/OAI",sagittal_slice)
...
def partition_data_semi(n_nets,list_label,list_bl,list_12m,root_dir, sagittal_slice=32):
    logging.info("********************* Partitioning data **********************")
    net_data_idx_map = None
    # list_label=os.path.join(root_dir,list_label)
    # list_bl=os.path.join(root_dir,list_bl)
    # list_12m=os.path.join(root_dir,list_12m)
    train_ds= load_sensetime_data_SEMI(list_label,list_bl,list_12m,root_dir,sagittal_slice)
    n_train = len(train_ds)  # Number of training samples
...
def load_partition_data_oai(client_number,batch_size,sagittal_num):
    root_dir = '../../../data/OAI'
...
def load_partition_data_oai_semi(client_number, batch_size, batch_size_lb,sagittal_num):
    root_dir = '../../../data/OAI'
...
if __name__=="__main__":
    ...
    train_data_local_dict, test_data_local_dict, num=load_partition_data_OAI(5,4,32) #client_number, batch_size, batch_size_lb,sagittal_num)
